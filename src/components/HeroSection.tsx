...
const HeroSection = () => {
  ...
  const stats = [
    { icon: Users, value: "50,000+", label: t("hero.stats.users") },
    { icon: Shield, value: "2,500+", label: t("hero.stats.companies") },
    { icon: TrendingUp, value: "150,000+", label: t("hero.stats.reviews") },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6 animate-fade-up" style={{ animationDelay: "0.1s" }}>
            ...
            <span className="block text-2xl md:text-3xl lg:text-4xl mt-2 font-normal text-muted-foreground">{t("hero.subtitle")}</span>
          </h1>
